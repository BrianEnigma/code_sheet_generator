...
static final int X_OFFSET = 275;
static final int Y_OFFSET = 750;
static final int ROW_HEIGHT = 78;
...
void drawSemaphore(int dots, int xPos, int yPos)
{
    ...
    for (int bit = 0; bit < 8; bit++)
    {
        ...
        switch(bit)
        {
            case 0: termX += 18; termY -= 18; break;
            case 1: termX += 25;              break;
            case 2: termX += 18; termY += 18; break;
            case 3:              termY += 25; break;
            case 4: termX -= 18; termY += 18; break;
            case 5: termX -= 25;              break;
            case 6: termX -= 18; termY -= 18; break;
            case 7:              termY -= 25; break;
        }
        stroke(255, 0, 0);
        strokeWeight(4);
        if ((dots & (0x01 << bit)) != 0)
...
//  dec  hex  bin  tern  oct  morse braille semaphore
    150, 150, 235, 190,  150, 60,   315,    150
};
...
void draw()
{
    ...
    // Content
    PFont baseFont = createFont("DejaVu Sans Mono", 50, true);
    textFont(baseFont);
    fill(255);
    // Headings
    textAlign(RIGHT);
